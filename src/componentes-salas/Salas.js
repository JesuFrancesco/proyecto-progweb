const salas = [
    {
        salaName: "Sala A",
        salaLocation: "Pabellon A - ULIMA",
        salaHistory: "La Facultad de Comunicación tiene tres estudios, los cuales son sets profesionales que se utilizan para televisión, streaming y diversas realizaciones audiovisuales.\n " 
        + "Cada uno de ellos está equipado con tres cámaras de video digitales full HD, switcher digital, pantallas de monitoreo tanto en Control y Estudio, dos tituladores y grabadoras / reproductoras de video.\n "
        + "El sonido comprende: consola de audio, micrófonos de mano, de pecho, boom y de vincha.\n "
        + "El sistema de iluminación trabaja con control de iluminación, luces alógenas de varios tipos: Fresnel, Scoop, Broad, Cañón, además del rack de control técnico con instrumentos de medición.\n ",
    ...
    {
        salaName: "Sala C",
        salaLocation: "Pabellon C - ULIMA",
        salaHistory: "pabellon c como el lenguaje de programacion c",
        salaSchedule: "John Doe • 4 Feb 2024",
        salaTimes: ["08:00", "10:00", "12:00", "14:00"],
    ...
    {
        salaName: "Sala F",
        salaLocation: "Pabellon F - ULIMA",
        salaHistory: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos blanditiis ullam fugit, reprehenderit quidem, libero enim dicta aut praesentium explicabo exercitationem harum quibusdam, quos architecto temporibus consequatur nulla nihil corrupti.",
        salaSchedule: "John Doe • 4 Feb 2024",
        salaTimes: ["08:00", "10:00", "12:00", "14:00"],
